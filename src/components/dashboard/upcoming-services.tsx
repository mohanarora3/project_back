  ...
  const services: ServiceItem[] = [
    {
      ...
      service: "Solar Panel Annual Maintenance",
      date: "Today",
      time: "2:00 PM",
      location: "BKC Office Rooftop",
      priority: "high",
      status: "confirmed",
    },
    {
      ...
      service: "Solar Inverter System Check",
      date: "Tomorrow",
      time: "10:00 AM",
    ...
    },
    {
      ...
      service: "Solar Panel Cleaning & Inspection",
      date: "Feb 15",
      time: "9:30 AM",
      location: "HITEC City Rooftop",
      priority: "medium",
      status: "confirmed",
    },
    {
      ...
      date: "Feb 16",
      time: "1:00 PM",
      location: "Cyber City Office Complex",
      priority: "high",
      status: "scheduled",
    },
    {
      ...
      service: "Solar System Performance Audit",
      date: "Feb 18",
      time: "8:00 AM",
      location: "Multiple Mall Rooftops",
      priority: "low",
      status: "scheduled",
    },
  ];
